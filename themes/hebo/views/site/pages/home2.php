    	...
    	<div id="myCarousel" class="carousel slide" style="min-height:430px;">
          ...
          <div class="carousel-inner">
            <div class="active item" style="min-height:430px;">
       	    	<img src="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/desa1.jpg" width="1000" height="430" />
            
            </div>
            
            <div class="item" style=" min-height:430px;">
            	<img src="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/desa2.jpg" width="1000" height="430" />
            </div>

            <div class="item" style=" min-height:430px;">
              <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/desa3.jpg" width="1000" height="430" />
            </div>
          </div>
          <!-- Carousel nav -->
              ...
              <li class="span6">
                ...
                <h3>Visi</h3>
                  	...
                  	<div class="round_background r-grey-light">
                		<img src="<?php echo Yii::app()->theme->baseUrl;?>/img/icons/smashing/visi.png" alt="" class="">
                     </div>
              ...
              <li class="span6">
                <div class="thumbnail">
                     ...
                     <div class="round_background r-red">
                		<img src="<?php echo Yii::app()->theme->baseUrl;?>/img/icons/smashing/Misi.png" alt="" class="">
                     </div>
