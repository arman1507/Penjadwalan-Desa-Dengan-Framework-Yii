...
<div class="row-fluid">
  ...
  <div class="span6">
		<a href="index.php" class="bek">
			     <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/giphy.gif" width="50" height="50" alt="Me" />
            	<img src="<?php echo Yii::app()->theme->baseUrl;?>/img/logo.jpg" width="50px"
	height="50px" />
           <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/giphy.gif" width="50" height="50" alt="Me" />
		</a>
  </div><!--/.span6 -->
